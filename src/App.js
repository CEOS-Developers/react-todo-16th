...
import { Container ,ListContainer,ListHeaderContainer, TaskListContainer} from "./ContainerStyled";
    ...
    <Container>
      ...
      {/* 날짜 및 제목 */}
        <Header color="grey" size="10px" marginBottom='0px' bold='normal'> 
          {new Date().getFullYear()+'년 '+(new Date().getMonth()+1)+'월 '+new Date().getDate()+'일 '+week[new Date().getDay()-1]+'요일'} 
        </Header>
